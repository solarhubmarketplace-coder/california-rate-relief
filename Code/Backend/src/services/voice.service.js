  ...
  try {
    ...
    try {
      ...
      const transcription = await openai.audio.transcriptions.create({
        ...
        prompt:
          "California Rate Relief Program solar qualification call. Ray the AI agent speaks with a homeowner about net metering, solar PPA, utility rates, and scheduling an assessment.", // Context to prevent hallucinations
      });

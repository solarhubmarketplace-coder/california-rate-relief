 ...
 * "sage" = calm, composed female — even-keeled, professional, not bubbly
 * Previous: "coral" was too warm/upbeat, sounded salesy. "ash" was male, too slow.
 * Bot name: Sarah
 */
const AI_VOICE = "sage";
...
Talk at a normal conversational speed. Don't drag your words out. Don't pause too long between words. You're not meditative, you're not a yoga instructor — you're a normal person on a phone call moving through a quick confirmation. Keep it moving. Brisk but not rushed. Think "coworker on a Monday morning" not "therapist in a session."

...
export const CITIES: CityData[] = [
  ...
  // =========================================================================
  {
    ...
    metaDescription:
      'Temecula residents pay ~$319/month for electricity. Learn your actual SCE rate, what solar costs in Temecula in 2026 and every option to lower your bill.',
...

  {
    ...
    metaDescription:
      'Murrieta residents pay ~$271/month for electricity. Learn your actual SCE rate, what solar costs in Murrieta in 2026 and every option to lower your bill.',
...

  {
    ...
    metaDescription: 'A 6.5kW system in Santa Rosa costs about $15,300. PG&E bills average $250/month at 41.5¢/kWh. See fire-season battery backup and ways to lower your bill.',
...

  {
    ...
    systemSizeKw: 7.0,
    systemCostCash: 16500,
    introText: 'Anaheim is one of the largest cities in Orange County, with about 350,000 residents, and it is not on SCE. Anaheim Public Utilities is a city-owned utility, and its residential rate of roughly 20\u00a2/kWh is well under the 34.5\u00a2 SCE charges next door. That single fact changes the whole solar calculation here, and most sales pitches get it wrong.',
    electricitySection: 'The average Anaheim household pays approximately $260 per month for electricity, or about $3,120 per year. The bill is driven by volume rather than by an extreme rate: air conditioning through an Orange County summer on a large house adds up even at APU\'s comparatively low price per kilowatt-hour. Because APU is publicly owned, it sets its own rates and its own net-metering terms, and it is not governed by the CPUC\'s NEM 3.0 decision. Any urgency you hear about NEM 3.0 deadlines does not apply to an Anaheim account.',
    solarPotentialText:
    ...
    whenSolarDoesntWork: 'Solar is a weaker fit in Anaheim than in neighboring SCE cities, and it is worth saying plainly. At roughly 20\u00a2/kWh you are displacing cheaper power, so payback runs longer than it would in Fullerton or Orange on SCE. If your bill is under about $150 a month, your roof is shaded, you are planning to move within a few years, or you are being sold on NEM 3.0 urgency that does not apply to APU customers, wait. Check APU\'s own rebate and net-metering terms before signing anything.',
    bottomLine: 'Anaheim is a real but selective solar market. APU\'s roughly 20\u00a2/kWh rate means the savings per kilowatt-hour are smaller than in SCE territory, so the households that benefit are the high-usage ones: large homes, pools, EVs, or heavy summer cooling. Excellent Orange County sun and APU\'s own net-metering terms still make it work for those homes. If your usage is modest, the honest answer is that solar pays back slowly here.',
    faqs: [
      ...
      { question: 'What is the average electric bill in Anaheim?', answer: 'Anaheim residents pay approximately $260 per month on Anaheim Public Utilities.' },
      { question: 'Can my HOA block solar panels?', answer: 'No. California\'s Solar Rights Act protects your right to install solar.' },
    ...
    metaDescription: 'Anaheim residents on Anaheim Public Utilities pay ~$260/month. Learn solar costs and every option to lower your bill.',
    ogTitle: 'Solar Savings in Anaheim, CA: 2026 Anaheim Public Utilities Rates & Options',
    ogDescription: 'Anaheim residents pay ~$260/month on Anaheim Public Utilities. Here\'s what solar costs and saves.',
...

  {
    ...
    metaDescription: 'An 8.0 kW system in San Mateo runs about $28,000. PG&E/PCEA bills average $240/month. Peninsula fog cuts output ~15% June-August. Battery options inside.',
...

  {
    ...
    metaDescription: 'An 8.5kW system in Irvine costs about $25,500. SCE bills average $260/month at 34.5¢/kWh. AB 2188 protects your right to install despite Irvine Ranch HOA rules.',
...

  {
    ...
    metaDescription: 'Huntington Beach residents on SCE pay ~$250/month. Learn solar costs, coastal considerations, multifamily solar options, EV incentives, and how to lower.',
...

  {
    ...
    metaDescription: 'El Dorado Hills residents on PG&E pay ~$280/month at 41.5¢/kWh. Learn solar costs, battery storage options, master-planned community benefits, and how to.',
...

  {
    ...
    metaDescription: 'Oceanside residents on SDG&E pay ~$205/month at 45.7¢/kWh (highest in CA). Learn solar costs, military family PPA options, Camp Pendleton airspace rules.',
  ...
  },
{
  ...
  metaDescription: 'Fontana households pay about $280 a month for electricity on SCE. See the local rate, sun hours and what a 9.5 kW system costs installed.',
...

{
  ...
  metaDescription:
    'Simi Valley residents pay ~$270/month for electricity. Learn what solar costs, SCE rates, fire-zone resilience benefits and battery storage options.',
...

{
  ...
  metaDescription:
    'Seaside residents pay ~$210/month for electricity. Learn solar costs, Monterey Bay fog patterns, Fort Ord military incentives, and Monterey Bay Community.',
...

{
  ...
  metaDescription:
    'Sunnyvale residents pay ~$270/month for electricity. Learn solar costs, employer solar incentives, EV charging integration, and Sunnyvale Clean Energy CCA.',
...

{
  ...
  metaDescription:
    'Watsonville residents pay ~$220/month for electricity. Learn solar costs, irrigation solar power, Pajaro Valley agricultural incentives, and water pump.',
...

{
  ...
  metaDescription:
    'Salinas residents pay ~$225/month for electricity. Learn solar costs, east vs. west valley sun differences, agricultural permitting, and irrigation power.',
...

{
  ...
  metaDescription:
    'Walnut Creek residents pay ~$265/month for electricity. Learn solar costs, Rossmoor design guidelines, MCE CCA export bonuses, and Ygnacio Valley heat.',
...

{
  ...
  metaDescription:
    'San Bernardino residents pay ~$290/month for electricity. Learn your actual SCE rate, what solar costs in San Bernardino in 2026, wildfire zone.',
...

{
  ...
  metaDescription:
    'Rancho Cordova residents pay ~$155/month — California\'s lowest rates. Learn SMUD\'s net metering incentives, what solar costs in Rancho Cordova in 2026.',
...

{
  ...
  metaDescription:
    'Pacific Grove residents pay ~$200/month. Learn how coastal fog affects solar, what historic preservation costs, and whether solar makes sense for this.',
...

{
  ...
  metaDescription:
    'Marina residents pay ~$205/month. Learn how Fort Ord redevelopment and solar-ready Dunes construction affect costs, and why Marina\'s government supports.',
...

{
  ...
  metaDescription:
    'Mountain View residents pay ~$275/month. Learn how tech culture, SVCE rates, and EV integration make Mountain View California\'s top solar + renewable.',
...

{
  ...
  metaDescription:
    'Redlands residents pay ~$265/month. Learn how historic preservation solar rules, fire-zone battery incentives, and university culture affect solar costs.',

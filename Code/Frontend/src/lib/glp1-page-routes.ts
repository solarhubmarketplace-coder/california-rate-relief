...
const livePages: PageRoute[] = [
  ...
  {
    path: '/tmates-vs-eden-health',
    template: 'provider-vs-provider',
    tier: 'B',
    status: 'live',
    targetKeyword: 'tmates vs eden health',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Built from shared TMatesCompareTemplate. Eden Health has NABP/PCAB/ACHC accreditation (transparent 503A) + branded GLP-1 access. Honest box: where TMates falls short on pharmacy disclosure + Trustpilot volume.',
  },
  {
    path: '/tmates-vs-medvi',
    template: 'provider-vs-provider',
    tier: 'B',
    status: 'live',
    targetKeyword: 'tmates vs medvi',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. MEDVi received Feb 2026 FDA misbranding warning (1 of 30+ telehealth firms). TMates has clean FDA record. Tiered vs flat-dose pricing comparison.',
  },
  {
    path: '/tmates-vs-strut-health',
    template: 'provider-vs-provider',
    tier: 'B',
    status: 'live',
    targetKeyword: 'tmates vs strut health',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Strut owns its in-house ACHC-accredited compounding pharmacy (rare safety advantage). TMates wins tirzepatide pricing; Strut wins on oral lozenge format + pharmacy transparency.',
  },
  {
    path: '/tmates-vs-skinnyrx',
    template: 'provider-vs-provider',
    tier: 'B',
    status: 'live',
    targetKeyword: 'tmates vs skinnyrx',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. SkinnyRx has 4.8/5 Trustpilot across 5K+ reviews — strongest reputation signal in category. TMates wins on price for 12-mo committers; SkinnyRx wins on consumer trust.',
  },
  {
    path: '/peptides',
    ...
    tier: 'B',
    status: 'live',
    targetKeyword: 'peptide therapy',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Index page for /peptides/[slug] dynamic route. Lists all 5 peptides (BPC-157, Ipamorelin/CJC-1295, PT-141, TB-500, AOD-9604) with regulatory context callout (Apr 2026 Cat-2 removals, July 2026 PCAC review).',
  },
  {
    ...
    tier: 'B',
    status: 'live',
    targetKeyword: 'bpc-157',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Gut + tissue repair peptide. Wolverine stack with TB-500. April 2026 Cat-2 removal. 503A-Rx via Desert Mobile, BeyondMD, Sands Wellness, Aspire.',
  },
  {
    path: '/peptides/ipamorelin-cjc-1295',
    template: 'peptide-stack',
    tier: 'B',
    status: 'live',
    targetKeyword: 'ipamorelin cjc-1295',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. GH secretagogue stack — muscle preservation during GLP-1 deficit. Evolved Medical $249/mo, Perfect B $445/cycle.',
  },
  {
    ...
    tier: 'B',
    status: 'live',
    targetKeyword: 'pt-141 bremelanotide',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Sexual health / libido. Vyleesi (FDA-approved for HSDD women). Counters GLP-1 libido drop via central pathway, not PDE5. Boston Medical Group, Hone, TestDepot.',
  },
  {
    ...
    tier: 'B',
    status: 'live',
    targetKeyword: 'tb-500 thymosin beta-4',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Recovery / soft-tissue repair. Stacked with BPC-157 (Wolverine). WADA-banned for athletes. BeyondMD, Perfect B, Sands.',
  },
  {
    ...
    tier: 'B',
    status: 'live',
    targetKeyword: 'aod-9604',
    estRevenueAtMaturity: 0,
    volume: 0,
    kd: 0,
    note: 'NEW 2026-05-08. Fat-loss HGH fragment. Manufacturer abandoned development after failed obesity trials. Honest red flag: weak evidence vs proven GLP-1 effect.',
  },
  {
...
const providerVsPages: PageRoute[] = [
  ...
  { path: '/compare/skinnyrx-vs-medvi',       template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'skinnyrx vs medvi', note: 'LIVE 2026-05-06. SkinnyRx (VERIFY — $500 CPA pending) vs MEDVi ($179-299 verified, editorial pick). Data caveat banner for SkinnyRx.' },
  { path: '/compare/skinnyrx-vs-trimrx',      template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'skinnyrx vs trimrx', note: 'LIVE 2026-05-06. Both VERIFY pricing. TrimRx edge (~$179 entry). StickyMobileCTA: TrimRx.' },
  { path: '/compare/skinnyrx-vs-ivim-health', template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'skinnyrx vs ivim', note: 'LIVE 2026-05-06. Both VERIFY pricing. Ivim editorial pick (microdosing); SkinnyRx $500 CPA potential noted.' },
  ...
  { path: '/compare/medvi-vs-ivim-health',    template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'medvi vs ivim', note: 'LIVE 2026-05-06. MEDVi ($179-299, editorial pick) vs Ivim Health (VERIFY pricing, microdosing specialist). MEDVi wins verified; Ivim wins microdosing.' },
  ...
  { path: '/compare/ivim-health-vs-trimrx',   template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'ivim vs trimrx', note: 'LIVE 2026-05-06. Ivim (VERIFY, microdosing) vs TrimRx ($179 entry confirmed, higher VERIFY). TrimRx sticky CTA.' },
  { path: '/compare/trimrx-vs-eden-health',   template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'trimrx vs eden', note: 'LIVE 2026-05-06. TrimRx ($179+ entry confirmed, higher tiers VERIFY) vs Eden Health ($229-299 verified). Eden editorial pick. Bloodwork value math section.' },
  { path: '/compare/gobymeds-vs-orderlymeds', template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'gobymeds vs orderlymeds', note: 'LIVE 2026-05-06. Both VERIFY pricing. No winner — VERIFY BOTH framing. TMates fallback CTA.' },
  { path: '/compare/gobymeds-vs-medvi',       template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'gobymeds vs medvi', note: 'LIVE 2026-05-06. GobyMeds (VERIFY all pricing) vs MEDVi ($179-299 verified). MEDVi editorial pick (verified pricing).' },
  { path: '/compare/orderlymeds-vs-medvi',    template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'orderlymeds vs medvi', note: 'LIVE 2026-05-06. OrderlyMeds VERIFY vs MEDVi ($179-299 verified). MEDVi clear editorial pick.' },
  { path: '/compare/gobymeds-vs-ivim-health', template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'gobymeds vs ivim', note: 'LIVE 2026-05-06. GobyMeds VERIFY vs Ivim Health (VERIFY pricing, microdosing/liraglutide USP). Ivim editorial pick.' },
  { path: '/compare/directmeds-vs-skinnyrx',  template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'directmeds vs skinnyrx', note: 'LIVE 2026-05-06. Both VERIFY pricing. SkinnyRx soft edge (brand presence). Verified alternatives callout.' },
  { path: '/compare/directmeds-vs-gobymeds',  template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'directmeds vs gobymeds', note: 'LIVE 2026-05-06. Both VERIFY — neutral, no pick. Push to verified providers (TMates/MEDVi/Eden) callout box.' },
  { path: '/compare/elevate-health-vs-skinnyrx', template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'elevate vs skinnyrx', note: 'LIVE 2026-05-06. Both VERIFY. SkinnyRx conditional pick (brand). Strut $99 + MEDVi $179 verified alternatives callout.' },
  { path: '/compare/elevate-health-vs-eden-health', template: 'provider-vs-provider', tier: 'B', status: 'live',   targetKeyword: 'elevate vs eden', note: 'LIVE 2026-05-06. Elevate VERIFY vs Eden ($229-299 verified, bloodwork). Eden clear winner. Editorial pick: Eden.' },
];

...
export const AFFILIATE_LINKS: Record<string, AffiliateLink> = {
  ...
  'glp1-embody': {
    ...
    status: 'active',
    network: 'katalys',
    commissionRate: '$400 default CPA + $200 sermorelin (cross-sell tier). Realized EPC $4.60, CR 1.31% — highest in stack (Katalys May 2026)',
    priceDisplay: '$149 first month / $299 flat refills (Spring Forward: $200 off + free shipping)',
  },
  'glp1-gala-health': {
    brand: 'Gala Health',
    ...
    priceDisplay: '$179–$199/mo (3-month plan, all-inclusive)',
  },
  'glp1-care-bare-rx': {
    brand: 'Care Bare Rx',

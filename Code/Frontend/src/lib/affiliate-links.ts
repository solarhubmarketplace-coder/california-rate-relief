...
export const AFFILIATE_LINKS: Record<string, AffiliateLink> = {
  ...
  'vivint': { brand: 'Vivint', url: 'https://www.vivint.com/', status: 'pending', network: 'awin', commissionRate: '$60-$120/sale equiv', priceDisplay: 'From $599 + $44/mo' }, 'yale-assure-lock-2': { brand: 'Yale', url: 'https://shopyalehome.com/products/assure-lock-2', status: 'pending', network: 'awin', commissionRate: '5-8%', priceDisplay: '$259' }, 'imilab-ec5': { brand: 'IMILAB', url: 'https://www.imilab.com/products/imilab-ec5', status: 'pending', network: 'awin', commissionRate: '5-10%', priceDisplay: '$79' }, 'lockly-vision-elite': { brand: 'LOCKLY', url: 'https://lockly.com/products/lockly-vision-elite', status: 'pending', network: 'awin', commissionRate: '6-10%', priceDisplay: '$399' }, 'august-wifi-smart-lock': { brand: 'August', url: 'https://august.com/products/august-wifi-smart-lock', status: 'pending', network: 'awin', commissionRate: '5-8%', priceDisplay: '$229' }, 'bluetti-ac500-awin': { brand: 'Bluetti', url: 'https://www.bluettipower.com/products/ac500-b300s-home-battery-backup', status: 'pending', network: 'awin', commissionRate: '5-8%', priceDisplay: '$3,599 (street)' }, 'jackery-explorer-2000-plus-awin': { brand: 'Jackery', url: 'https://www.jackery.com/products/jackery-explorer-2000-plus-portable-power-station', status: 'pending', network: 'awin', commissionRate: '5-8%', priceDisplay: '$1,499 (street)' }, 'allpowers-r4000': { brand: 'ALLPOWERS', url: 'https://iallpowers.com/products/allpowers-r4000-portable-power-station', status: 'pending', network: 'awin', commissionRate: '6-10%', priceDisplay: '$1,499' }, 'powersmart-80v-mower': { brand: 'PowerSmart', url: 'https://www.powersmartusa.com/', status: 'pending', network: 'awin', commissionRate: '5-10%', priceDisplay: '$549' }, 'vivi-electric-bike': { brand: 'Vivi', url: 'https://www.vivi-bike.com/', status: 'pending', network: 'awin', commissionRate: '5-10%', priceDisplay: '$899' }, amazon: {
    brand: 'Amazon',

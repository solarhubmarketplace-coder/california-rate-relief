...
export const glp1Providers: GLP1Provider[] = [
  ...
  // ✅ #1 SkinnyRx — Gronk-verified, full content build pending JS catalog screenshot
  {
    ...
    comparisonsAvailable: ['embody', 'eden-health', 'medvi', 'system-labs', 'trimrx'],
  ...
  // ✅ #3 MEDVi — Gronk-verified pricing, full catalog VERIFY (loading shell)
  {
    ...
    lastUpdated: '2026-05-02',
    lastVerified: '2026-05-01',
    comparisonsAvailable: ['embody', 'system-labs', 'skinnyrx', 'eden-health', 'gala-health'],
  ...
  // 🔍 #4 DirectMeds — fully site-crawled, sublingual is the unique angle
  {
    ...
    lastUpdated: '2026-05-02',
    lastVerified: '2026-05-02',
    comparisonsAvailable: ['embody', 'system-labs', 'skinnyrx', 'eden-health', 'medvi'],
  },
  ...
  // 🔍 #5 Ivim Health — fully site-crawled, MICRODOSING + LIRAGLUTIDE + WEGOVY PILL are unique
  {
    ...
    lastUpdated: '2026-05-02',
    lastVerified: '2026-05-02',
    comparisonsAvailable: ['embody', 'system-labs', 'eden-health', 'medvi'],
  },
  ...
  // ✅ #6 Eden Health — Gronk-verified + site-crawled, NAD+ ECOSYSTEM is unique
  {
    ...
    lastUpdated: '2026-05-02',
    lastVerified: '2026-05-02',
    comparisonsAvailable: ['embody', 'gala-health', 'system-labs', 'care-bare-rx', 'directmeds'],
  ...
  // ============================================================
  // KATALYS-APPROVED PROVIDERS (added 2026-05-05)
  // 4 active programs from Katalys network, all approved on glp1comparehub.com.
  // Realized EPC/CR data from Katalys partner dashboard, not estimates.
  // Tracking pattern: track.revoffers.com/aff_c?offer_id=<PROGRAM_ID>&aff_id=12427
  // ============================================================

  // ⭐ Highest-EPC GLP-1 program in the active stack ($4.60 EPC, 1.31% CR)
  // Verified URL: joinem.co (NOT embodyhealth.com or embody.com — those don't resolve)
  {
    ...
    status: 'Active',
    name: 'Embody',
    tagline: 'Flat $299/mo refills + GLP-1 gum (needle-free)',
    description: 'Tele-health platform at joinem.co offering medically guided GLP-1 weight loss with compounded semaglutide and tirzepatide, plus an innovative GLP-1 gum format for needle-averse patients. $149 first month (physician review, dosing plan, 1:1 guidance, metabolic report, medication, free shipping). Flat $299/mo on refills — no dose-escalation upcharges, HSA/FSA eligible, pause anytime. Active "Spring Forward" promo: $200 off first order + free expedited shipping.',
    badge: 'Best Overall',
    monthlyPrice: '$149 first month / $299 flat refills',
    medications: 'Compounded Semaglutide + Tirzepatide (injectable + GLP-1 gum)',
    medicationsList: [
      'Compounded Semaglutide (Injectable)',
      'Compounded Tirzepatide (Injectable)',
      'GLP-1 Gum (oral chewable tirzepatide — needle-free daily alternative)',
    ],
    medicationType: ['Compounded'],
    rating: 4.7,
    starsDisplay: '★★★★★',
    bestFor: 'Patients who want flat-rate pricing and a needle-free GLP-1 option',
    bestForList: [
      'Patients who want flat $299/mo refills with no dose-escalation fees',
      'Needle-averse patients exploring GLP-1 gum as a daily alternative',
      'Cost-conscious buyers ($149 first month with Spring Forward $200 off)',
      'HSA/FSA users (eligible)',
    ],
    cancellation: 'Anytime — pause anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'joinem.co + Katalys partner dashboard (Gronk-verified May 2026)',
    pros: [
    ...
    pricingTable: [
      { plan: 'First month (with Spring Forward $200 off)', price: '$149' },
      { plan: 'Flat refill price (any dose)', price: '$299/mo' },
    ],
    promo: 'Spring Forward: $200 off first order + free expedited shipping',
    bottomLine: 'The data leader in the Katalys-approved stack: $4.60 EPC and 1.31% conversion rate beat every other GLP-1 program we track. The flat $299/mo refill price (no dose-escalation upcharges) is genuinely uncommon in compounded telehealth, and the GLP-1 gum is a real differentiator for needle-averse patients.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['eden-health', 'gala-health', 'directmeds', 'system-labs'],
  },

  // ⭐ Solid mid-tier GLP-1 ($3.60 EPC, 1.18% CR, $349 CPA)
  // Verified URL: galaglp1.com (NOT galahealth.com)
  {
    ...
    status: 'Active',
    name: 'Gala Health',
    tagline: 'All-inclusive 3-month GLP-1 bundles from $179–$199/mo',
    description: 'US-based telehealth weight-loss platform at galaglp1.com offering compounded GLP-1/GIP (semaglutide or tirzepatide) on 3-month plans starting at $199/mo (some homepage offers list $179/mo entry). All-inclusive flat fee covers provider consults, async support, and shipping. No separate intro discount — pricing is locked at checkout based on medication + plan.',
    badge: 'Best for 3-Month Bundles',
    monthlyPrice: '$179–$199/mo (3-month plan)',
    medications: 'Compounded Semaglutide or Tirzepatide (GLP-1/GIP)',
    medicationsList: [
      'Compounded Semaglutide (Injectable)',
      'Compounded Tirzepatide / GIP (Injectable)',
    ],
    medicationType: ['Compounded'],
    rating: 4.5,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients ready to commit to a 3-month plan for the lowest all-inclusive price',
    bestForList: [
      'Patients comfortable with a 3-month commitment (lowest LTV-bundled price)',
      'Buyers wanting all-inclusive flat-fee pricing (no surprise add-ons)',
      'Patients wanting nationwide US telehealth access',
    ],
    cancellation: '3-month commitment for bundled pricing',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'galaglp1.com + Katalys partner dashboard (Gronk-verified May 2026)',
    pros: [
      'Realized EPC $3.60, CR 1.18% (Katalys-verified)',
      '$349 default CPA',
      'All-inclusive flat fee — no separate consult, support, or shipping fees',
      'Strong 3-month bundling for LTV-focused buyers',
    ],
    cons: [
    ...
    pricingTable: [
      { plan: 'Compounded GLP-1 (3-month plan, semaglutide)', price: 'From $179/mo' },
      { plan: 'Compounded GLP-1 (3-month plan, tirzepatide/GIP)', price: 'From $199/mo' },
    ],
    bottomLine: 'High-converting funnel with strong all-inclusive 3-month bundling. Best fit for buyers who want a flat fee with no add-ons and are ready to commit beyond month one.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['embody', 'eden-health', 'system-labs'],
  },

  // Multi-vertical: GLP-1 + hair + sexual health + NAD+ (perfect cross-sell funnel)
  // Verified URL: carebarerx.com
  {
    ...
    status: 'Active',
    name: 'Care Bare Rx',
    tagline: 'Weight loss + hair + sexual health + NAD+ — discreet multi-care',
    description: 'Multi-vertical telehealth platform at carebarerx.com offering compounded semaglutide and tirzepatide (oral + injectable) for weight loss, plus standalone hair growth, sexual health/ED, and NAD+ programs. Weight-loss treatments start at $199/mo. Hair growth $99/mo, sexual health/ED $99/mo, NAD+ $199/mo — same provider for cross-vertical care.',
    badge: 'Best Multi-Vertical',
    monthlyPrice: 'From $199/mo (weight loss)',
    medications: 'Compounded Semaglutide + Tirzepatide (oral + injectable) + hair + sexual health + NAD+',
    medicationsList: [
      'Compounded Semaglutide (Injectable + Oral)',
      'Compounded Tirzepatide (Injectable + Oral)',
      'Hair Growth ($99/mo standalone)',
      'Sexual Health / ED ($99/mo standalone)',
      'NAD+ ($199/mo standalone)',
    ],
    medicationType: ['Compounded'],
    rating: 4.4,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients who want one platform for weight loss + hair + sexual health + longevity',
    bestForList: [
      'Patients seeking discreet, one-platform care across multiple verticals',
      'Buyers interested in oral compounded GLP-1 (alongside injectable)',
      'Patients wanting hair regrowth or NAD+ alongside their weight-loss program',
    ],
    cancellation: 'Anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'carebarerx.com + Katalys partner dashboard (Gronk-verified May 2026)',
    pros: [
      '$300 default CPA + 6 payout tiers (cross-vertical conversions to hair, sexual health, NAD+)',
      'Multi-vertical care under one provider — unique in the active stack',
      'Both oral AND injectable compounded GLP-1 (most providers are injectable-only)',
      'Standalone $99/mo hair and sexual health programs (cross-sell paths)',
    ],
    cons: [
    ...
    pricingTable: [
      { plan: 'Weight loss (compounded GLP-1, oral or injectable)', price: 'From $199/mo' },
      { plan: 'Hair growth (standalone)', price: '$99/mo' },
      { plan: 'Sexual health / ED (standalone)', price: '$99/mo' },
      { plan: 'NAD+ (standalone)', price: '$199/mo' },
    ],
    bottomLine: 'The only true multi-vertical provider in the active stack. Best fit when the content angle includes cross-sell quizzes ("weight loss + hair") or one-platform discreet care positioning. Cross-vertical CPA tiers boost effective revenue per converted lead.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['eden-health', 'embody', 'system-labs'],
  },

  // ⭐ LOWEST GLP-1 ENTRY + ADJACENT-PEPTIDE PLAY (NAD+, B-12, Sermorelin)
  // Verified URL: systemlabs.com
  {
    ...
    status: 'Active',
    name: 'System Labs',
    tagline: 'Lowest GLP-1 entry ($179/mo) + longevity stack — NAD+, B-12, sermorelin',
    description: 'Cutting-edge telehealth platform at systemlabs.com focused on performance, longevity, and preventative wellness. Lab-tested peptides and therapies from certified pharmacies. Sub-verticals span Anti-aging, B-12 (MIC+B12), GLP-1, NAD+, and Sermorelin — the only provider in our stack covering the full adjacent-peptide cluster, AND the lowest GLP-1 entry price ($179/mo) of any active program.',
    badge: 'Best Value',
    monthlyPrice: 'GLP-1 $179/mo (lowest entry)',
    medications: 'Compounded GLP-1 + NAD+ + B-12 + Sermorelin (oral + injectable)',
    medicationsList: [
      'Compounded GLP-1/GIP — $179/mo (lowest entry in stack)',
      'NAD+ — $149/mo ($79 first month)',
      'B-12 / MIC+B12 — $89/mo',
      'Sermorelin (Injectable) — $219/mo ($109 first month)',
      'Sermorelin (Oral compounded) — $159/mo ($79 first month)',
    ],
    medicationType: ['Compounded'],
    rating: 4.5,
    starsDisplay: '★★★★☆',
    bestFor: 'Cost-conscious GLP-1 buyers + biohackers building a longevity stack',
    bestForList: [
      'Cost-conscious buyers — $179/mo is the lowest GLP-1 entry in our verified stack',
      'Biohackers stacking GLP-1 with NAD+ ($79 first month) for energy/longevity',
      'Patients wanting B-12 / MIC alongside GLP-1 (separate $89/mo program)',
      'Patients exploring oral or injectable sermorelin (both formats available)',
    ],
    cancellation: 'Anytime — no long-term commitments',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'systemlabs.com + Katalys partner dashboard (Gronk-verified May 2026)',
    pros: [
      'Lowest GLP-1 entry price ($179/mo) of any active program in our stack',
      'Only provider covering full adjacent-peptide cluster (NAD+, B-12, Sermorelin oral + injectable)',
      'First-month discounts across the board: NAD+ $79, oral sermorelin $79, injectable sermorelin $109',
      '$100 default CPA + 4 payout tiers (Anti-aging / B-12 / GLP-1 / NAD+) — cross-sell revenue',
      'No long-term commitments on any program',
    ],
    cons: [
      'Lower default CPA ($100) than dedicated GLP-1-only programs ($300-400)',
      'Multi-vertical focus — less GLP-1-specific brand recognition',
    ],
    pricingTable: [
      { plan: 'Compounded GLP-1/GIP', price: '$179/mo' },
      { plan: 'NAD+', price: '$149/mo ($79 first month)' },
      { plan: 'B-12 / MIC+B12', price: '$89/mo' },
      { plan: 'Sermorelin (Oral)', price: '$159/mo ($79 first month)' },
      { plan: 'Sermorelin (Injectable)', price: '$219/mo ($109 first month)' },
    ],
    bottomLine: 'The cheapest GLP-1 entry in our active stack at $179/mo, plus the only home for adjacent-peptide content (NAD+, B-12, sermorelin oral and injectable). The longevity bundle hook is unique — strong cross-sell potential. Lower per-conversion CPA than dedicated GLP-1 brands, but the lowest-entry pricing should drive higher conversion rates to offset.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['embody', 'directmeds', 'eden-health', 'gala-health'],
  },

  // ============================================================
  // KATALYS-APPROVED PROVIDERS (added 2026-05-06)
  // Strut Health + TMates — both joined/approved on Katalys but were missing
  // from this registry. TMates has the highest EPC in the entire account ($16.09).
  // ============================================================

  // ⭐ Multi-vertical: GLP-1 + Hair + Skin + ED + Herpes | 7.12% CR — 2nd highest CR in stack
  // Verified URL: struthealth.com | AK excluded
  {
    ...
    status: 'Active',
    name: 'Strut Health',
    tagline: 'No-video telehealth — GLP-1, hair, skin, ED + 2-day shipping',
    description: 'LegitScript & HIPAA-compliant telehealth platform offering compounded GLP-1 (semaglutide and tirzepatide) alongside hair loss, skin care, sexual health, and more — all reviewed by US-licensed physicians in ≤1 business day with no video visit required. Pharmacy-fresh compounds from a US board-certified compounding pharmacy; 2-day discreet shipping, plain packaging, free follow-up care.',
    monthlyPrice: 'Oral Semaglutide from $99/mo, Oral Tirzepatide from $199/mo',
    medications: 'Compounded Semaglutide + Tirzepatide, Hair Loss (Finasteride/Dutasteride), Oral Sermorelin, Skin Care, Herpes treatment, ED/Sexual Health',
    medicationsList: [
    ...
    rating: 4.6,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients wanting multi-condition care from one no-video telehealth platform',
    bestForList: [
      'Patients who prefer no-video consultations (written review only)',
      'Multi-condition patients — GLP-1 weight loss + hair loss + skin in one platform',
      'Patients who value fast pharmacy turnaround (2-day discreet shipping)',
      'LegitScript-conscious buyers who want compliance-vetted providers',
    ],
    cancellation: 'Cancel anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'struthealth.com — VERIFY (pricing not crawled yet; do NOT publish pricing until confirmed)',
    pros: [
      '2nd highest CR in active Katalys stack (7.12%) — high-converting funnel',
      'No video visit required — fully async physician review (≤1 business day)',
      'Multi-vertical: GLP-1, hair, skin, ED, herpes — cross-sell potential matches Care Bare Rx',
      'LegitScript & HIPAA certified — strong trust signal',
      '2-day discreet shipping with plain packaging',
      'Free follow-up care included',
    ],
    cons: [
      'AK excluded (Alaska state restriction)',
      'Compounded only — no branded GLP-1 (Wegovy/Zepbound)',
      'Pricing not yet crawled — monthlyPrice needs live verification',
    ],
    pricingTable: [
      { plan: 'Compounded Semaglutide', price: 'VERIFY on struthealth.com' },
      { plan: 'Compounded Tirzepatide', price: 'VERIFY on struthealth.com' },
      { plan: 'Oral Sermorelin', price: 'VERIFY on struthealth.com' },
      { plan: 'Hair Loss (Finasteride)', price: 'VERIFY on struthealth.com' },
    ],
    features: {
      availability: 'All US states EXCEPT Alaska (AK)',
      fulfillment: 'US board-certified compounding pharmacy',
      fees: 'Bundled — no video visit, physician review ≤1 business day',
      delivery: '2-day discreet shipping, plain packaging',
      plans: 'Monthly subscription',
    },
    bottomLine: 'Strut Health\'s 7.12% conversion rate is the second-highest in the active Katalys stack — a proven funnel. The no-video-visit async model and multi-vertical menu (GLP-1 + hair + skin + ED + Herpes) make it a strong fit for content targeting multi-condition patients. Pricing must be verified before publishing specific numbers.',
    lastUpdated: '2026-05-06',
    lastVerified: '2026-05-06',
    comparisonsAvailable: ['care-bare-rx', 'embody', 'eden-health', 'directmeds'],
  },

  // ⭐⭐ HIGHEST-EPC PROGRAM IN ENTIRE KATALYS ACCOUNT ($16.09 EPC, 6.43% CR, $250 CPA)
  // Full program name: TMates GLP1 Prescription Weight Loss
  // By: TMates - Prescription Offers
  // Verified URL: tmates.com/products/semaglutide
  {
    ...
    status: 'Active',
    name: 'TMates',
    tagline: 'Highest-converting GLP-1 program in our stack — semaglutide + multi-vertical',
    description: 'TMates offers GLP-1 prescription weight loss (semaglutide, tirzepatide) alongside NAD+, TRT, ED, skin care, and hair loss — all under one telehealth umbrella. The TMates GLP1 Prescription Weight Loss program on Katalys is the #1 highest-EPC program in our entire affiliate account at $16.09, with a 6.43% conversion rate that rivals the best programs in the health & wellness vertical.',
    monthlyPrice: 'Semaglutide $158-$249/mo, Tirzepatide $167-$297/mo (1-12 mo plans)',
    medications: 'Compounded Semaglutide + Tirzepatide (GLP-1), NAD+, TRT, ED, Skin Care, Hair Loss',
    medicationsList: [
    ...
    rating: 4.7,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients who want compounded GLP-1 through a multi-vertical telehealth platform with licensed prescriber oversight',
    bestForList: [
      'Patients wanting the highest-converting GLP-1 telehealth funnel (6.43% CR — Katalys-verified)',
      'Multi-vertical patients combining GLP-1 with NAD+, TRT, or ED treatment',
      'Patients prioritizing licensed-prescriber oversight on compounded sema/tirz under a 503A pharmacy partner',
    ],
    cancellation: 'Cancel anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'tmates.com/products/semaglutide and /products/tirzepatide — pricing matches the values published on the static /providers/tmates page (live-crawled 2026-05-06). Re-verify before each monthly refresh.',
    pros: [
      ...
      '$250 CPA per sale',
      'Multi-vertical: GLP-1, NAD+, TRT, ED, Hair — cross-sell funnel depth',
      'Same price across all dosages (sema 0.25-2.4mg, tirz 2.5-15mg) — predictable cost as dose escalates',
    ],
    cons: [
      'Compounded GLP-1 only (no branded Wegovy/Zepbound)',
      '12-month plan required for the lowest per-month price tier',
    ],
    pricingTable: [
      { plan: 'Semaglutide — 1 month', price: '$249/mo' },
      { plan: 'Semaglutide — 3 month', price: '$217/mo' },
      { plan: 'Semaglutide — 6 month', price: '$175/mo' },
      { plan: 'Semaglutide — 12 month', price: '$158/mo' },
      { plan: 'Tirzepatide — 1 month', price: '$297/mo' },
      { plan: 'Tirzepatide — 3 month', price: '$267/mo' },
      { plan: 'Tirzepatide — 6 month', price: '$217/mo' },
      { plan: 'Tirzepatide — 12 month', price: '$167/mo' },
    ],
    features: {
      availability: 'United States',
      fulfillment: 'Licensed medical professionals + compounding pharmacy',
      fees: 'Bundled — verify on tmates.com',
      delivery: 'Verify on tmates.com',
      plans: 'Monthly — verify',
    },
    bottomLine: 'TMates GLP1 is the standout performer in our Katalys stack — $16.09 EPC and 6.43% CR are data that command attention. A $250 CPA combined with that conversion rate makes it the highest revenue-per-click program we run. Should be featured prominently once pricing is verified and detail page is built.',
    lastUpdated: '2026-05-06',
    lastVerified: '2026-05-06',

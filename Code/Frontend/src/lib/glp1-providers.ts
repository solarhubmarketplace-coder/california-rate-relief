...
export const glp1Providers: GLP1Provider[] = [
  ...
  // ⭐ Highest-EPC GLP-1 program in the active stack ($4.60 EPC, 1.31% CR)
  {
    ...
    status: 'Active',
    name: 'Embody',
    tagline: 'Modern GLP-1 telehealth — semaglutide, tirzepatide, and GLP-1 gum',
    description: 'Tele-health platform offering medically guided GLP-1 weight loss with semaglutide and tirzepatide, plus innovative GLP-1 gum and injectable therapies. Plans starting at $149/mo with a 2-minute online intake. Highest realized EPC in our active affiliate stack as of May 2026.',
    badge: 'Best Overall',
    ...
    medicationsList: [
      ...
      'GLP-1 Gum (innovative oral format)',
      'Sermorelin (adjacent peptide)',
    ],
    medicationType: ['Compounded'],
    rating: 4.7,
    starsDisplay: '★★★★★',
    bestFor: 'Patients who want fast onboarding and an innovative GLP-1 oral-format option',
    bestForList: [
      'Patients who want a 2-minute intake with fast provider review',
      'Patients curious about GLP-1 gum as an injectable alternative',
      'Cost-conscious buyers (entry tier $149/mo)',
    ],
    cancellation: 'Anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'Katalys partner dashboard (live affiliate data, May 2026)',
    pros: [
      'Highest realized EPC ($4.60) in our active stack',
      'Real conversion rate 1.31% (Katalys-verified)',
      '$400 default CPA + $200 sermorelin payout',
      'GLP-1 gum is a unique oral-format differentiator',
    ],
    cons: [
    ...
    pricingTable: [
      { plan: 'Starter (semaglutide or tirzepatide)', price: 'From $149/mo' },
    ],
    bottomLine: 'The data-leader in the Katalys-approved stack: $4.60 EPC and 1.31% conversion rate beat every other GLP-1 program we track. The GLP-1 gum format is genuinely novel for needle-averse patients.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['eden-health', 'gala-health', 'directmeds'],
  },
  ...
  // ⭐ Solid mid-tier GLP-1 ($3.60 EPC, 1.18% CR, $349 CPA)
  {
    ...
    status: 'Active',
    name: 'Gala Health',
    tagline: 'US-based GLP-1 telehealth with high-converting funnel',
    description: 'US-based telehealth weight-loss program offering personalized treatment plans following a licensed medical consultation. Treatments may include GLP-1 based therapies when prescribed. High-converting funnel with nationwide coverage and competitive CPA payouts.',
    monthlyPrice: 'Varies by plan',
    medications: 'GLP-1 based therapies (provider-prescribed)',
    medicationsList: ['GLP-1 weight-loss medications (provider-discretion)'],
    medicationType: ['Compounded', 'Brand Name'],
    rating: 4.5,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients who want a fast-onboarding US-based GLP-1 telehealth program',
    bestForList: [
      'Patients who want quick approval and nationwide US coverage',
      'Patients comparing high-converting telehealth funnels',
    ],
    cancellation: 'Anytime',
    labsIncluded: false,
    consultIncluded: true,
    ...
    cons: [
      'Catalog details limited until full crawl',
      'Pricing transparency requires intake completion',
    ],
    bottomLine: 'High-converting GLP-1 funnel with strong realized EPC. Solid mid-tier slot in the affiliate comparison table.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['embody', 'eden-health'],
  },

  // Multi-vertical: GLP-1 + hair regrowth + sexual health (LGBTQ+ angle, "self-care with pride")
  {
    ...
    status: 'Active',
    name: 'Care Bare Rx',
    tagline: 'Weight loss, hair regrowth, sexual health — discreet care',
    description: 'Multi-vertical telehealth platform offering GLP-1 weight loss (Ozempic, Wegovy, and more) plus hair regrowth and sexual health. "Self-care with pride" positioning targets LGBTQ+ patients and those wanting discreet delivery. Weight-loss treatments start at $199/mo.',
    monthlyPrice: 'From $199/mo',
    medications: 'Branded GLP-1 (Ozempic, Wegovy) + hair + sexual health',
    medicationsList: [
      'Branded Ozempic',
      'Branded Wegovy',
      'Hair regrowth (oral medications)',
      'Sexual health medications',
    ],
    medicationType: ['Brand Name', 'Compounded'],
    rating: 4.4,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients who want bundled telehealth across weight, hair, and sexual health with discreet delivery',
    bestForList: [
      'Patients seeking discreet door delivery',
      'Patients who want one-platform care across weight + hair + sexual health',
      'LGBTQ+ patients seeking inclusive care positioning',
    ],
    cancellation: 'Anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'Katalys partner dashboard (live affiliate data, May 2026)',
    pros: [
      '$300 default CPA + 6 payout tiers (covers cross-sell to hair and sexual health)',
      'Multi-vertical bundling unique in the GLP-1 stack',
      'Branded Ozempic and Wegovy availability',
    ],
    cons: [
      'Multi-vertical focus may mean less GLP-1-specific expertise',
      'Pricing transparency requires intake',
    ],
    bottomLine: 'The only multi-vertical provider in the active stack. Strong fit when content angle includes hair/sexual-health cross-sell or LGBTQ+ inclusive positioning.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['eden-health', 'embody'],
  },

  // ⭐ ADJACENT-PEPTIDE PLAY — covers NAD+, B-12, Sermorelin, anti-aging cluster
  {
    ...
    status: 'Active',
    name: 'System Labs',
    tagline: 'Peptides + GLP-1 + NAD+ + B-12 longevity stack',
    description: 'Cutting-edge telehealth platform focused on performance, longevity, and preventative wellness. Lab-tested peptides and therapies sourced from certified pharmacies. Sub-verticals span Anti-aging, B-12, GLP-1, and NAD+ — the only provider in our stack that covers the full adjacent-peptide cluster.',
    badge: 'Best for Compounded',
    monthlyPrice: 'Varies by therapy',
    medications: 'GLP-1 + NAD+ + B-12 + Sermorelin + Anti-aging peptides',
    medicationsList: [
      'Compounded GLP-1 (semaglutide / tirzepatide)',
      'NAD+ (multiple formats)',
      'B-12 / MIC injections',
      'Sermorelin',
    ...
    rating: 4.5,
    starsDisplay: '★★★★☆',
    bestFor: 'Patients combining GLP-1 with adjacent peptides (NAD+, B-12, sermorelin) in a longevity stack',
    bestForList: [
      'Biohackers stacking GLP-1 with NAD+ for energy/longevity',
      'Patients wanting B-12 / MIC alongside GLP-1',
      'Patients exploring sermorelin or anti-aging peptide protocols',
    ],
    cancellation: 'Anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'Katalys partner dashboard (live affiliate data, May 2026)',
    pros: [
      'Only provider in active stack covering full adjacent-peptide cluster (NAD+, B-12, Sermorelin)',
      '$100 default CPA + 4 payout tiers spanning Anti-aging / B-12 / GLP-1 / NAD+',
      'Lab-tested peptides from certified pharmacies',
      'Best fit for stack/combo content (B-12 + GLP-1, NAD+ + GLP-1, etc.)',
    ],
    cons: [
      'Lower default CPA ($100) than dedicated GLP-1-only programs',
      'Multi-vertical focus — less GLP-1-specific brand recognition',
    ],
    bottomLine: 'The strategic fit for any /tirzepatide-with-b12, /nad-iv-therapy, /sermorelin, /peptide-therapy-near-me, or /glp-1-stack page. Lower per-conversion payout, but the only provider that monetizes the adjacent-peptide content cluster.',
    lastUpdated: '2026-05-05',
    lastVerified: '2026-05-05',
    comparisonsAvailable: ['embody', 'directmeds'],
  },
];

...
export const glp1Providers: GLP1Provider[] = [
  ...
  // Strut Health: 7.12% CR (2nd highest in stack), async no-video model, multi-vertical
  {
    ...
    description: 'LegitScript and HIPAA-compliant telehealth platform offering compounded GLP-1 (semaglutide and tirzepatide) alongside hair loss, skin care, and sexual health. US-licensed physicians review cases in ≤1 business day with no video visit required. Pharmacy-fresh compounds from a US board-certified pharmacy; 2-day discreet shipping, plain packaging, free follow-up care.',
    monthlyPrice: 'Verify on struthealth.com',
    ...
    cancellation: 'Verify on struthealth.com',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'struthealth.com — VERIFY pricing before publishing specific numbers',
    pros: [
    ...
    cons: [
      ...
      'Compounded only — no branded GLP-1 (Wegovy/Zepbound)',
      'Pricing not yet crawled — verify before publishing specific numbers',
    ],
    pricingTable: [
      ...
      { plan: 'Hair Loss', price: 'VERIFY on struthealth.com' },
    ],
    features: {
    ...
    bottomLine: "Strut Health's 7.12% CR is the 2nd highest in the active Katalys stack. The async no-video model and multi-vertical menu (GLP-1 + hair + skin + ED) make it a strong fit for multi-condition patient content. Must verify pricing before publishing.",
  ...
  // TMates: #1 HIGHEST EPC in entire Katalys account ($16.09, 6.43% CR, $250 CPA)
  {
    ...
    status: 'Active',
    name: 'TMates',
    tagline: '#1 highest-EPC GLP-1 program in our stack — semaglutide, NAD+, TRT, ED',
    description: 'TMates offers GLP-1 prescription weight loss (semaglutide, tirzepatide) alongside NAD+, TRT, ED, skin care, and hair loss under one telehealth umbrella. Ranks #1 in our entire Katalys account by EPC: $16.09 realized EPC with 6.43% conversion rate. Licensed medical professionals guide treatment; conversion action is Sale.',
    monthlyPrice: 'Verify on tmates.com/products/semaglutide',
    ...
    cancellation: 'Verify on tmates.com',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'tmates.com/products/semaglutide — VERIFY pricing before publishing specific numbers',
    pros: [
      ...
      '$250 CPA per sale',
      'Multi-vertical: GLP-1, NAD+, TRT, ED, Hair — deep cross-sell potential',
    ],
    cons: [
      'Pricing not yet crawled — verify before publishing specific numbers',
      'Compounded GLP-1 only (no branded Wegovy/Zepbound confirmed)',
    ],
    pricingTable: [
      { plan: 'Semaglutide (GLP-1 weight loss)', price: 'VERIFY on tmates.com/products/semaglutide' },
      { plan: 'Tirzepatide (GLP-1)', price: 'VERIFY on tmates.com' },
      { plan: 'NAD+', price: 'VERIFY on tmates.com' },
      { plan: 'TRT', price: 'VERIFY on tmates.com' },
    ],
    features: {
      ...
      plans: 'Monthly — verify on site',
    },
    bottomLine: 'TMates GLP1 is the standout performer in our Katalys account: $16.09 EPC and 6.43% CR are proven numbers. At $250 CPA and that conversion rate it is the highest revenue-per-click program we run. Feature prominently once pricing is verified and a dedicated detail page is built.',
    lastUpdated: '2026-05-06',
    lastVerified: '2026-05-06',
    comparisonsAvailable: ['embody', 'eden-health', 'gala-health', 'strut-health'],
  },
];

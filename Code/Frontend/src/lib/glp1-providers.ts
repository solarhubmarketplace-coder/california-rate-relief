...
export const glp1Providers: GLP1Provider[] = [
  ...
  // Strut Health + TMates — joined/approved on Katalys but missing from registry.
  // TMates has the HIGHEST EPC in the entire Katalys account ($16.09 EPC, 6.43% CR).
  // ============================================================

  // Strut Health: 7.12% CR (2nd highest in stack), async no-video model, multi-vertical
  {
    ...
    description: 'LegitScript and HIPAA-compliant telehealth platform specializing in ORAL compounded GLP-1 — semaglutide from $99/mo and tirzepatide from $199/mo on auto-refill — alongside hair loss, skin care, and sexual health. US-licensed physicians review cases in ≤1 business day with no video visit required. Free shipping, free follow-up care, cancel anytime. The lowest-entry verified oral GLP-1 price in our Katalys stack.',
    monthlyPrice: 'Oral Semaglutide from $99/mo, Oral Tirzepatide from $199/mo',
    medications: 'Compounded Semaglutide + Tirzepatide, Hair Loss, Oral Sermorelin, Skin Care, ED',
    medicationsList: [
    ...
    bestForList: [
      'Patients who prefer no-video consultations (written review ≤1 business day)',
      'Multi-condition patients — GLP-1 weight loss + hair + skin in one platform',
      'LegitScript-conscious buyers who want compliance-vetted compounded GLP-1',
      'Patients who value fast pharmacy turnaround (2-day discreet shipping)',
    ],
    cancellation: 'Cancel anytime',
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'struthealth.com (live-crawled 2026-05-06)',
    pros: [
      '2nd highest CR in active Katalys stack (7.12%) — proven high-converting funnel',
      'No video visit required — fully async physician review',
      'Multi-vertical: GLP-1, hair, skin, sexual health — cross-sell potential',
      'LegitScript + HIPAA certified — strong trust/compliance signal',
      '2-day discreet shipping + free follow-up care included',
    ],
    cons: [
      'AK excluded (Alaska state restriction)',
      'Compounded only — no branded GLP-1 (Wegovy/Zepbound)',
      'Strut focuses on ORAL GLP-1 only — no injectable semaglutide/tirzepatide on public catalog',
    ],
    pricingTable: [
      { plan: 'Oral Semaglutide (auto-refill)', price: 'From $99/mo (save 21%)' },
      { plan: 'Oral Tirzepatide (auto-refill)', price: 'From $199/mo (save 17%)' },
      { plan: 'Hair Loss (Finasteride)', price: 'See struthealth.com' },
      { plan: 'Sexual Health (Sildenafil/Tadalafil)', price: 'See struthealth.com' },
    ],
    features: {
      availability: 'All US states EXCEPT Alaska (AK)',
      fulfillment: 'US board-certified compounding pharmacy',
      fees: 'No video visit — physician review ≤1 business day',
      delivery: '2-day discreet shipping, plain packaging',
      plans: 'Monthly subscription',
    },
    bottomLine: "Strut Health's 7.12% CR is the 2nd highest in the active Katalys stack, and the $99/mo entry on oral semaglutide is the lowest verified GLP-1 entry-tier price in our stack. Async no-video model + multi-vertical menu (GLP-1 + hair + skin + ED) make this a strong fit for cost-conscious multi-condition content. Note: Strut is oral-only — patients wanting injectable should be routed to TMates, Embody, or Eden.",
  ...
  // TMates: #1 HIGHEST EPC in entire Katalys account ($16.09, 6.43% CR, $250 CPA)
  {
    ...
    status: 'Active',
    name: 'TMates',
    tagline: '$158-$249/mo semaglutide, $167-$297/mo tirzepatide — same price all doses',
    badge: 'Best Overall',
    description: 'TMates offers GLP-1 prescription weight loss — semaglutide from $158/mo on a 12-month plan, tirzepatide from $167/mo — alongside NAD+, TRT, ED, skin care, and hair loss. Same price across all dosages (no titration upcharges). Available in injectable AND oral formats. 2,400+ patients. Ranks #1 in our entire Katalys account by EPC ($16.09) with a 6.43% conversion rate.',
    ...
    medicationsList: [
      'Compounded Semaglutide (GLP-1 weight loss)',
      'Compounded Tirzepatide (GLP-1 weight loss)',
      'NAD+',
    ...
    labsIncluded: false,
    consultIncluded: true,
    priceSource: 'tmates.com/products/semaglutide + /tirzepatide (live-crawled 2026-05-06)',
    pros: [
      ...
      '12-month plan: $158/mo sema, $167/mo tirz — among the most competitive long-term GLP-1 pricing in our verified stack',
      'Available in BOTH injectable and oral formats',
      '2,400+ patients (real userbase, not a startup)',
      'Multi-vertical: GLP-1, NAD+, TRT, ED, Hair — cross-sell potential',
    ],
    cons: [
    ...
    pricingTable: [
      { plan: 'Semaglutide — 1 month (any dose)', price: '$249' },
      { plan: 'Semaglutide — 3 months', price: '$650 ($217/mo, save 13%)' },
      { plan: 'Semaglutide — 6 months', price: '$1,050 ($175/mo, save 30%)' },
      { plan: 'Semaglutide — 12 months', price: '$1,900 ($158/mo, save 37%)' },
      { plan: 'Tirzepatide — 1 month (any dose)', price: '$297' },
      { plan: 'Tirzepatide — 3 months', price: '$800 ($267/mo, save 10%)' },
      { plan: 'Tirzepatide — 6 months', price: '$1,299 ($217/mo, save 27%)' },
      { plan: 'Tirzepatide — 12 months', price: '$1,999 ($167/mo, save 44%)' },
    ],
    features: {
      availability: 'United States',
      fulfillment: 'Licensed medical professionals + compounding pharmacy',
      fees: 'All-inclusive — medication + ongoing support included; same price all doses',
      delivery: 'Free shipping included',
      plans: '1, 3, 6, or 12-month plans — bigger plan = bigger discount (up to 44% off on 12-mo tirzepatide)',
    },
    bottomLine: 'TMates is the standout performer in our Katalys account: $16.09 EPC and 6.43% CR are proven numbers, not estimates. The 12-month plan at $158/mo (sema) or $167/mo (tirz) is genuinely competitive vs Eden Health 3-mo intro and Embody flat $299/mo refills. Same-price-all-doses + injectable+oral options + multi-vertical (NAD+, TRT, ED) make this our top-recommended provider for shoppers committing 6+ months.',
    lastUpdated: '2026-05-06',
    lastVerified: '2026-05-06',

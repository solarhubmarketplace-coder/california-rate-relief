...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.glp1comparehub.com/ozempic-vs-mounjaro' },
  openGraph: {
    ...
    url: 'https://www.glp1comparehub.com/ozempic-vs-mounjaro',
    siteName: 'GLP1CompareHub',
    images: [{ url: 'https://www.glp1comparehub.com/img/glp1/og-image.jpg', width: 1200, height: 630, alt: 'Ozempic vs Mounjaro 2026 — GLP1CompareHub' }],
  },
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.glp1comparehub.com/ozempic-vs-mounjaro',
  },
  citation: [
    {
      '@type': 'CreativeWork',

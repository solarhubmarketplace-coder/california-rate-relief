...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.glp1comparehub.com/match' },
  openGraph: {
    ...
    url: 'https://www.glp1comparehub.com/match',
    siteName: 'GLP1CompareHub',
    type: 'website',
    images: [{ url: 'https://www.glp1comparehub.com/img/glp1/og-image.jpg', width: 1200, height: 630, alt: 'GLP-1 Match Quiz — GLP1CompareHub' }],
  },

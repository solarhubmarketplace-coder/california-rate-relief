...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [{ url: '/img/glp1/og-sermorelin-for-weight-loss.jpg', width: 1168, height: 784, alt: 'Sermorelin for Weight Loss — telehealth guide 2026' }],
  },
};
...
export default function SermorelinForWeightLossPage() {
  ...
  return (
    <GLP1Layout>
      ...
      <StickyMobileCTA href={buildGlp1AffiliateUrl('ivim-health', 'sermorelin-for-weight-loss')} brandName="Ivim Health" pricePitch="Sermorelin + GLP-1 microdosing — verify pricing at Ivim Health" />

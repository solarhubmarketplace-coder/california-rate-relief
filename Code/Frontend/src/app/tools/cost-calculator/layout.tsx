...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.glp1comparehub.com/tools/cost-calculator' },
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://www.glp1comparehub.com/img/glp1/og-image.jpg', width: 1200, height: 630, alt: 'GLP-1 Cost Calculator — GLP1CompareHub' }],
  },

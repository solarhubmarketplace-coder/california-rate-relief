  ...
  return (
    <div className='min-h-screen flex bg-slate-50'>
      ...
      <div className='hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#084F5A] via-[#38737F] to-[#6099A5] overflow-hidden'>
        <div className='absolute inset-0 bg-[url("data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"0.05\"%3E%3Cpath d=\"M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\"%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E")] opacity-100'></div>
        <div className='relative z-10 flex flex-col items-center justify-center p-12 text-white w-full'>
          <div className='max-w-md space-y-8'>
            <div className='flex items-center gap-4'>
              <Image src='/img/logo.svg' alt='California Rate Relief' width={64} height={64} className='h-16 w-16' />
              <div>
                <h1 className='text-3xl font-bold'>California Rate Relief</h1>
                <p className='text-white/80 text-base mt-1'>CRM Platform</p>
              </div>
            </div>
      ...
      <div className='flex-1 flex items-center justify-center p-8 bg-white'>
        <Card className='w-full max-w-lg shadow-lg border border-slate-200'>
          <CardHeader className='space-y-4 pb-8'>
            <div className='flex items-center gap-4'>
              <Image src='/img/logo.svg' alt='California Rate Relief' width={56} height={56} className='h-14 w-14' />
              <div>
                <CardTitle className='text-3xl font-bold text-slate-900'>
                  Welcome Back
                </CardTitle>
                <CardDescription className='text-base text-slate-600'>
                  Sign in to California Rate Relief
                </CardDescription>
              </div>
            </div>
          </CardHeader>

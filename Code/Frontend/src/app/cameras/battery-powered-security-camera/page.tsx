        ...
        <div className='container mx-auto px-4'>
          <article className='max-w-3xl mx-auto'>
            ...
            <div className='mb-8 rounded-xl overflow-hidden border' style={{ borderColor: '#1e293b' }}>
              <img src='https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=1200&q=80&auto=format&fit=crop' alt='Battery powered security camera' className='w-full h-auto max-h-96 object-contain' loading='lazy' />
            </div>

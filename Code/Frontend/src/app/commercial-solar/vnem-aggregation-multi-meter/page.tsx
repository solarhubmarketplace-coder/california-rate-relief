...
export const metadata: Metadata = {
  ...
  description: "California's VNEM and NEM Aggregation let one solar array credit multiple meters on the same or contiguous parcels. PG&E, SCE, SDG&E rules and AB 2175.",

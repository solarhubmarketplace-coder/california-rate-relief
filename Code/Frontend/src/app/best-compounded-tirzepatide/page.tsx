  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'System Labs at $179/mo is the lowest verified entry price in our active stack. TMates starts at $297/mo for a single month but drops to $167/mo on the 12-month plan (same price at every dose). For lowest per-month sustained cost at full commitment, the TMates annual plan is competitive with System Labs.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'TMates leads our active affiliate stack with a $16.09 EPC and 6.43% conversion rate (Katalys-verified May 2026) — more than 3x the EPC of any other provider. Embody is second at $4.60 EPC and 1.31% conversion rate. Higher EPC and conversion typically reflect strong website conversion design, transparent pricing, and trustworthy onboarding.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The April 1, 2026 enforcement shift restricted 503A pharmacies to true patient-specific compounding. Many telehealth providers continue serving customers under that narrower exception. The April 30 503B exclusion proposal could further tighten supply if finalized after the June 29 comment period. We re-verify provider availability monthly.',
      },
    },
    {
      '@type': 'Question',
      name: 'Does TMates charge the same price at every dose?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. TMates uses a flat same-price-all-doses model. Tirzepatide on the monthly plan is $297/mo regardless of dose. On the 12-month plan it is $167/mo regardless of dose. This is unusual — most compounded GLP-1 telehealth providers increase your price as your dose escalates.',
      },
    },
  ],
};
...
export default function BestCompoundedTirzepatidePage() {
  ...
  const tMatesUrl = buildAffiliateUrl('glp1-tmates', 'best-compounded-tirzepatide');
  ...
  return (
    <GLP1Layout>
      ...
      <main>
        ...
        <section className='py-10 md:py-14 bg-white'>
          <div className='max-w-5xl mx-auto px-4 md:px-6'>
            ...
            <p className='text-sm mb-6 text-center' style={{ color: '#6B7B82' }}>
              All six are verified-active May 6, 2026. Click any name for the full review.
            </p>
            <div className='space-y-3'>
              <RankRow
                ...
                name='TMates'
                badge='Best Overall'
                price='$167–$297/mo tirzepatide (same price all doses)'
                why='Highest realized EPC ($16.09) and conversion rate (6.43%) in our entire affiliate stack — more than 3x any other provider. Same price at every dose means no surprises as your prescription escalates.'
                slug='tmates'
              />
              <RankRow
                rank={2}
                ...
                why='$4.60 EPC, 1.31% conversion rate. Spring Forward $200 off + free shipping. GLP-1 gum format for needle-averse patients. Flat $299/mo refills regardless of dose.'
                slug='embody'
              />
              <RankRow
                rank={3}
          ...
          <div className='max-w-4xl mx-auto px-4 md:px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <SafetyRow
                ...
                body='Live-pulled from each provider site by Gronk on May 6, 2026. We disclose first-month vs ongoing rates separately so the headline price reflects the real ongoing cost.'
              />
              <SafetyRow
                icon={<ShieldCheck className='h-5 w-5' style={{ color: '#7CA982' }} />}
              ...
              <SafetyRow
                ...
                body='Needle-free formats (sublingual, GLP-1 gum), same-price-all-doses models, longevity stacks (NAD+ / B-12 / sermorelin), and multi-vertical care earn explicit ranking weight when they uniquely serve a patient profile.'
              />
              <SafetyRow
                icon={<ShieldCheck className='h-5 w-5' style={{ color: '#7CA982' }} />}
        ...
        <section className='py-10 md:py-14 bg-white'>
          <div className='max-w-4xl mx-auto px-4 md:px-6'>
            ...
            <DetailedReview
              ...
              badge='Best Overall'
              priceHeadline='$167–$297/mo tirzepatide · Same price all doses'
              promo='12-month plan locks tirzepatide at $167/mo — save $1,560 vs monthly'
              metric='Realized EPC $16.09 · CR 6.43% (Katalys May 2026) — #1 in account'
              summary='TMates is the data winner in our entire GLP-1 affiliate stack — $16.09 EPC and 6.43% conversion rate, more than 3× the EPC of any other provider. The same-price-all-doses model is a standout differentiator: as your prescription escalates from 2.5mg to 15mg, your price does not move. Monthly tirzepatide runs $297; commit to 12 months and that drops to $167/mo. All doses, no surprises.'
              pros={[
                'Highest EPC ($16.09) and conversion rate (6.43%) in our active account — #1 by a wide margin',
                'Same price at every dose — no escalation upcharges as prescription increases',
                '12-month plan at $167/mo is the most competitive annual tirzepatide price in the stack',
                'Semaglutide also available ($158–$249/mo) for patients wanting flexibility',
                'Licensed medical oversight on every prescription',
                'Discreet doorstep delivery included',
              ]}
              cons={[
                'Monthly plan ($297) is higher than some competitors at entry tier',
                'Committing to 12 months required to hit lowest price',
                'No needle-free format options (injectable only)',
              ]}
              bestFor='Patients who want the highest-converting telehealth funnel with transparent same-price-all-doses tirzepatide, especially those planning multi-month treatment and wanting predictable costs.'
            />
            ...
            <DetailedReview
              ...
              summary='Embody is the flat-rate pick. The $299/mo refill price never changes regardless of dose escalation — most competitors raise prices as your prescription increases. GLP-1 gum is the only oral chewable tirzepatide in our verified stack, making this the top pick for patients with strong needle aversion.'
              pros={[
                'Flat $299/mo refills — no dose-escalation upcharges (unusual in compounded telehealth)',
                ...
                'Pause anytime — no long-term commitment required',
                'Strong EPC $4.60 and CR 1.31% (second-best in tirzepatide stack)',
              ]}
              cons={[
                'No branded GLP-1 (Wegovy/Zepbound) options',
                'Lab work not included in base price',
                'EPC/CR trails TMates significantly',
              ]}
              bestFor='Buyers who want flat-rate pricing immune to dose escalation, AND patients exploring GLP-1 gum as a needle-free daily alternative to injections.'
            />
            ...
            <DetailedReview
              ...
              pros={[
                'Lowest GLP-1 entry price in the active stack ($179/mo)',
              ...
              cons={[
                ...
                'EPC data not available in Katalys dashboard',
              ]}
            ...
            <DetailedReview
              ...
              summary='Direct Meds is the only verified provider offering compounded sublingual (under-the-tongue) tirzepatide drops at $224.10/mo, plus injectable tirzepatide at $297-$399. The sublingual format is a genuine differentiator for needle-averse patients who also want to avoid GLP-1 gum. Adjacent peptide menu (Sermorelin, NAD+, Epithalon) and supplement line broaden the platform.'
              pros={[
              ...
              cons={[
                ...
                'No branded GLP-1 (Wegovy/Zepbound) options',
                'Injectable tirzepatide tier ($399/mo) is higher than some competitors',
              ]}
            ...
            <DetailedReview
              ...
              cons={[
                'Higher first-month and ongoing pricing than System Labs entry tier',
                'No branded GLP-1 (Wegovy/Zepbound) options',
            ...
            <DetailedReview
              ...
              bestFor='Buyers ready to commit to 3 months upfront for a low all-inclusive price — no hidden consult or shipping fees.'
            />
          </div>
        </section>
        ...
        <section className='py-10 md:py-14' style={{ backgroundColor: '#F0EBE0' }}>
          <div className='max-w-7xl mx-auto px-4 md:px-6'>
            ...
            <p className='text-sm mb-6 text-center' style={{ color: '#6B7B82' }}>
              Pricing verified May 6, 2026. All providers ship to all 50 US states.
            </p>
            <GLP1ComparisonTable
        ...
        <RelatedGuides currentPath="/best-compounded-tirzepatide" />
          ...
          <div className='max-w-3xl mx-auto px-4 md:px-6'>
            ...
            >
              ...
              <div className='flex flex-wrap justify-center gap-3'>
                ...
                <Link
                  href='/tmates-vs-embody'
                  className='inline-flex items-center gap-2 px-7 py-3.5 rounded-full font-bold transition-all'
                  style={{ color: 'white', border: '1.5px solid white' }}
                >
                  TMates vs Embody Deep Dive
                </Link>
              </div>
            </div>
          </div>
      ...
      {/* Sticky mobile CTA — TMates is #1 overall pick */}
      <StickyMobileCTA
        href={tMatesUrl}
        brandName='TMates'
        pricePitch='Tirzepatide from $167/mo · Same price at every dose'
      />
    </GLP1Layout>
  );
}
...
function RankRow({ rank, name, badge, price, why, slug }: { rank: number; name: string; badge: string; price: string; why: string; slug: string }) {
  return (
    <div className='flex items-start gap-4 p-5 rounded-2xl' style={{ backgroundColor: rank === 1 ? '#F4EBD0' : '#F8F4ED', border: `1px solid ${rank === 1 ? '#D4A33A' : '#E5DDC8'}` }}>
      <div
      ...
      <div className='flex-1'>
        <div className='flex flex-wrap items-baseline gap-3 mb-1'>
          ...
          <span className='text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full' style={{ backgroundColor: rank === 1 ? '#D4A33A' : '#F4EBD0', color: rank === 1 ? 'white' : '#7A6020' }}>
            {rank === 1 && <Trophy className='h-2.5 w-2.5 inline mr-0.5' />}
            {badge}
          </span>

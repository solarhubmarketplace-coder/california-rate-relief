...
<div className='flex items-center gap-4 text-sm text-muted-foreground'>
            ...
            <div className='mb-8 rounded-xl overflow-hidden border' style={{ borderColor: '#1e293b' }}>
              ...
              <img src='https://electricbikereview.com/wp-content/assets/2021/07/rad-power-bikes-radrover-6-plus-stock-high-step-black.jpg' alt='Rad Power Bikes e-bike lineup' className='w-full h-auto max-h-[480px] object-cover' loading='eager' />
            </div>

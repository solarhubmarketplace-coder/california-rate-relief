...
<p className="text-lg text-muted-foreground mb-3">
      ...
      <section className="container mx-auto px-4 max-w-3xl mb-12">
        <div className="rounded-xl p-6 text-center border-2" style={{ backgroundColor: '#0a3d1f', borderColor: '#16a34a' }}>
          ...
          <p className="mb-4" style={{ color: '#d4d4d8' }}>The Editor&apos;s Pick electric dirt bike is sitting at our recommended price right now — lock it in before promo windows shift.</p>
          <BuyButton productKey="sur-ron-light-bee-x" source="best-electric-dirt-bike-adults-final-cta" variant="secondary" label="See Today&apos;s Best Price" />
        </div>
      </section>
      <ReviewFooter />

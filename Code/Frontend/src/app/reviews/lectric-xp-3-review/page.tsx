...
<div className='flex items-center gap-4 text-sm' style={{ color: '#a1a1aa' }}>
            ...
            <div className='mb-8 rounded-xl overflow-hidden border' style={{ borderColor: '#1e293b' }}>
              ...
              <img src='https://www.nycbicycleshop.com/2049/lectric-xp-30-folding-electric-bike.jpg' alt='Lectric XP 3.0 folding e-bike' className='w-full h-auto max-h-[480px] object-cover' loading='eager' />
            </div>

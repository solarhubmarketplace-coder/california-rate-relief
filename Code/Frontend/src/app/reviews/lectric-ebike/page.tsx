...
<div className='flex items-center gap-4 text-sm text-muted-foreground'>
            ...
            </header><div className='mb-8 rounded-xl overflow-hidden border' style={{borderColor:'#1e293b'}}><img src='https://images.unsplash.com/photo-1571333250630-f0230c320b6d?w=1200&q=80&auto=format&fit=crop' alt='Lectric folding e-bike' className='w-full h-auto max-h-[480px] object-cover' loading='eager' /></div>

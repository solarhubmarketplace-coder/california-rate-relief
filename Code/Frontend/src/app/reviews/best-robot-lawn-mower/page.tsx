...
<div
            ...
            <div className='mb-8 rounded-xl overflow-hidden border' style={{ borderColor: '#1e293b' }}>
              <img src='https://images.unsplash.com/photo-1589923188900-85dae523342b?w=1200&q=80&auto=format&fit=crop' alt='Robot lawn mower on grass' className='w-full h-auto max-h-96 object-contain' loading='lazy' />
            </div>

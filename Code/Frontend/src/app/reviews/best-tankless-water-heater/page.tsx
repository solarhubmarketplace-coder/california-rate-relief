...
<div
      ...
      <section className="container mx-auto px-4 max-w-3xl mb-12">
        <div className="rounded-xl p-6 text-center border-2" style={{ backgroundColor: '#0a3d1f', borderColor: '#16a34a' }}>
          ...
          <p className="mb-4" style={{ color: '#d4d4d8' }}>The Editor&apos;s Pick tankless water heater is sitting at our recommended price right now — lock it in before promo windows shift.</p>
          <BuyButton productKey="rinnai-ru199in" source="best-tankless-water-heater-final-cta" variant="secondary" label="See Today&apos;s Best Price" />
        </div>
      </section>
      <ReviewFooter />

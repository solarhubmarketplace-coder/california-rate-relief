        ...
        <div className="container mx-auto px-4">
          <article className="max-w-4xl mx-auto">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-foreground mb-6">More from California Rate Relief</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <Link
                  href="/reviews"
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    See how much California homeowners save with solar — check 76 cities.
                  </p>
                </Link>
                <Link
                  href="/blog"
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    California utility rates, net metering, PPA guides, and energy-saving tips.
                  </p>
                </Link>
              </div>
            </section>
            ...
            <section className="mb-8">
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 md:p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-foreground mb-3">
                  Charge Your E-Bike with Free Solar Energy
                </h2>
                <p className="text-foreground/80 max-w-2xl mx-auto mb-6 leading-relaxed">
                  An e-bike paired with rooftop solar means your transportation cost drops to
                  zero. California homeowners can qualify for programs that put solar on your roof
                  at no cost out of pocket, with fixed monthly payments that are typically 30-50%
                  less than your current utility bill. Power your home, your e-bike, and your
                  future — all from the sun.
                </p>
                <Link
                  href="/solar-savings"

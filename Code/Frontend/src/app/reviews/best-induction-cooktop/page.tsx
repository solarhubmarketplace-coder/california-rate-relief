...
<div className="flex items-center gap-4 text-sm" style={{ color: '#a1a1aa' }}>
            ...
            <div className='mb-8 rounded-xl overflow-hidden border' style={{ borderColor: '#1e293b' }}>
              <img src='https://images.unsplash.com/photo-1556911220-bff31c812dba?w=1200&q=80&auto=format&fit=crop' alt='Induction cooktop in kitchen' className='w-full h-auto max-h-96 object-contain' loading='lazy' />
            </div>

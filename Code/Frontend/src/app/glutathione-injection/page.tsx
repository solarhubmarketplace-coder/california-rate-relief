...
export default function GlutathioneInjectionPage() {
  ...
  return (
    <GLP1Layout>
      ...
      <StickyMobileCTA href={buildGlp1AffiliateUrl('eden-health', 'glutathione-injection')} brandName="Eden Health" pricePitch="Glutathione + full peptide menu — at-home injection from $79/mo" />

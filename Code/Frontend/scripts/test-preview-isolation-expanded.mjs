...
try {
  ...
  await fs.writeFile('../../evidence/growth-review/preview-isolation.json',JSON.stringify({passed:true,requestInterception:false,externalResponses,csp,calculatorUsable:true,syntheticInquiryStored:true,gtagConfigured:false},null,2));
